...
export class initialMigration1673027246111 implements MigrationInterface {
    name = 'initialMigration1673027246111'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "addresses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "district" character varying(120) NOT NULL, "zipCode" character varying(120) NOT NULL, "number" character varying(30) NOT NULL, "city" character varying(60) NOT NULL, "state" character varying(60) NOT NULL, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
